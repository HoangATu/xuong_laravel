...
class OrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sdt_nguoi_nhan' => 'required|regex:/^([0-9\s\-\+\(\)]*)$/|min:10',
