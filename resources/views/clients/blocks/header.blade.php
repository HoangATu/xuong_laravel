                            ...
                            <ul class="nav align-items-center justify-content-end">
                                ...
                                <li class="language">
                                    ...
                                    <ul class="dropdown-list">
                                        <li><a href="#"><img src="{{ asset ('assets/clients/img/icon/en.png')}}" alt="flag"> english</a></li>
                                        <li><a href="#"><img src="{{ asset ('assets/clients/img/icon/fr.png')}}" alt="flag"> french</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="main-menu-area">
                            <div class="main-menu">
                                ...
                                <nav class="desktop-menu">
                                    <ul>
                                        <li ><a href="{{route('index.index')}}">Home</i></a>
                                            {{-- <ul class="dropdown">
                                        ...
                                        <li class="position-static"><a href="#">Pages </i></a>
                                            {{-- <ul class="megamenu dropdown">
                                                ...
                                                <li class="megamenu-banners d-none d-lg-block">
                                                    <a href="product-details.html">
                                                        <img src="{{asset ('assets/clients/img/banner/img1-static-menu.jpg')}}" alt="">
                                                    </a>
                                                </li>
                                                <li class="megamenu-banners d-none d-lg-block">
                                                    <a href="product-details.html">
                                                        <img src="{{asset ('assets/clients/img/banner/img2-static-menu.jpg')}}" alt="">
                                                    </a>
                                                </li>
                                            </ul> --}}
                                        </li>
                                        ...
                                        <li><a href="blog-left-sidebar.html">Blog </i></a>
                                            {{-- <ul class="dropdown">
                ...
                <div class="mobile-navigation">
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            <li class="menu-item-has-children"><a href="{{route('index.index')}}">Home</a></li>
